...
public class SedishMapperTest {
    ...
    public void shouldReplacePatternWithDesiredString() throws IOException,
        ...
        String modifiedSentence = "1332795134246        Mar 26 20:52:11 nyc.example.net nginx: api.soundcloud.com 10.120.13.52 - - [26/Mar/2012:20:52:11 +0000] \"POST /check/me?client_id=dbb8a8f&secret=558285f0077b&fruit_type=apple&BANANA&sex=m@l3 HTTP/1.0\" 401 392 \"-\" \"-\" \"-\" \"41.125.195.222, 10.120.13.52\" \"https\"";
        ...
        configuration.set(TO_REPLACE_PARAMETER, "username=(\\S(?!&))+.");
